export declare enum CommunicationCodes {
    ...
    GET_USER = "[UsersService] Get UserEntity",
    GET_USER_BY_GOOGLE_ID = "[UsersService] Get UserEntity By Google Id",
    GET_USER_BY_ID = "[UsersService] Get UserEntity By ID",
    GET_USER_BY_EMAIL = "[UsersService] Get UserEntity By Email",
    CREATE_USER = "[UsersService] Create UserEntity",
    CREATE_USER_BY_GOOGLE = "[UsersService] Get UserEntity By Google",
    UPDATE_USER = "[UsersService] Update UserEntity",
    REMOVE_USER = "[UsersService] Remove UserEntity",
    RESET_USER_PASSWORD = "[UsersService] Reset UserEntity Password",
    LOGIN = "[AuthService] Login UserEntity",
    LOGIN_BY_GOOGLE = "[AuthService] Login UserEntity By Google",
    ...
    GET_PROJECTS_LIST_BY_USER = "[ProjectsService] Get Projects By UserEntity",
    ...
    GET_USER_HASH_BY_HASH = "[UsersService] Get UserEntity Hash By Hash",
    ...
    CHANGE_USER_PASSWORD = "[UsersService] Change UserEntity Password",
